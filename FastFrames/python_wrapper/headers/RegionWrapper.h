...
class RegionWrapper {
    public:
         ...
         * @param v2
         */
        void addVariableForProfile(const std::string& v1, const std::string& v2) {
            m_region->addVariableForProfile(v1, v2);
        };
         ...
         */
        const std::vector<std::string> variablesForProfile() const {
            const std::vector<std::pair<std::string,std::string>> &combinations = m_region->variablesForProfile();
            std::vector<std::string> combinations_python;
